...
""", unsafe_allow_html=True)
    ...
    if operation == "Create Video":
        ...
        if st.button("🚀 Upload Video"):
            if video_file is not None:
                ...
                st.warning("⚠️ Please upload a video file before clicking 'Upload Video'")    
    ...
    # --- UPDATE VIDEO ---
        ...
        st.header("✏️ Update Video Details")
        ...
        try:
            ...
            if videos.get('items'):
                ...
                if video_options:
                    ...
                    st.warning(f"⚠️ You are about to delete: {selected_title}")
                    st.markdown(f"🆔 Video ID: `{video_id}`")
                    
                    confirm = st.checkbox("⚠️ I understand that this action cannot be undone")
                    if st.button("🗑️ Delete Video") and confirm:
                        try:
        ...
        if analysis_type == "Fetch All Video Metadata":
            ...
            if st.button("🔍 Get Insights"):
                if query:
                    ...
                    st.warning("⚠️ Please enter a query about your video metadata.")